...
function setup() {
    ...
    textSize(18);
    text("To create your personal Mind-Map, you will need to rate 6 categories on a scale from 0 to 5, based on the impact they have on your daily life." ,15 ,25, 650,100);
